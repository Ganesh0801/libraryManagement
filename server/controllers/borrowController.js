...
import { calculateFine } from "../utils/fineCalulator.js";
...
export const returnBorrowBook = catchAsyncErrors(async (req, res, next) => {
  ...
  if (!user) {
    return next(new ErrorHandler("User not founnd", 404));
  }
  ...
  res.status(200).json({
    ...
    message:
      fine !== 0
        ? `the book has been returned successfully. The total charges , including a fine $${
            fine + book.price
          } `
